...
class DeclarationMetadata {
	...
	File outputFile = new File("../../analysis/parsed/declaration_metadata.txt")
	...
	def run() {
		...
		projectFiles.each { file ->
			...
			result << translator.translateDeclarationMetadata(projectId, metadataFolder, file)
		}
