...
Our results give more visibility over the point of view of programmers about the use of types.
...
A simple heuristic to determine the kind of the class was used.
...
Programmers may consider that delicate contracts, such as t hose defined by protected methods, should be well documented and thus are typed more often.
...
In addition, they might be the first element which programmers interact with when dealing with a new module.
