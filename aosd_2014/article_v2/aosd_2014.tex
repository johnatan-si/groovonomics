...
% TODO make this a little shorter, maybe drop hierarchy in paragraphs since this is so small
% Could you say something about what ind of developers use Groovy. Ie to do
% what? There is some discussion of this later, but it should be mentioned 
% as early as possible, to justify the interest of the study.
