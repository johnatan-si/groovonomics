...
\hline
\hline
\multirow{2}{*}{Public}			& Protected	& 0.000 & (-0.21,-0.18)	\\ 
								& Private	& 0.000 &   (0.28,0.31)	\\
\hline  
\multirow{2}{*}{Protected}		& Public	& 0.000 & (0.18,0.21)	\\
								& Private	& 0.000 & (0.54,0.57)	\\
\hline  
\multirow{2}{*}{Private}		& Public	& 0.000 & (-0.31,-0.28)	\\
								& Protected	& 0.000 & (-0.57,-0.54)	\\
\hline  
\end{tabular}
...
\hline 
\hline 
Field                             & 0.002	& (0.000, 0.000) \\ \hline
Constructor Parameter  & 0.397	& (0.000, 0.000) \\ \hline
Method Parameter         & 0.000	& (-0.500, -0.389) \\ \hline
Method Return              & 0.000	& (0.231, 0.250) \\ \hline
Local Variable               & 0.000	& (-0.058, -0.030) \\ 
\hline 
\end{tabular}
\label{tab:test_utest_type}
\caption{Mann-Whitney U test for tests}
\end{table}
...
\caption{Usage of types in projects by declaration type depending on the background of the programmers of a projects}
\end{figure}
...
\caption{Usage of types in projects by declaration visibility depending on the background of the programmers of a projects}
\end{figure}	
...
\caption{Mann-Whitney U Test results for declaration types depending on the background of the programmers of a projects}
\end{table}
...
\caption{Mann-Whitney U Test results for declaration visibility depending on the background of the programmers of a projects}
\end{table}
...
% PROJECT SIZE
\subsection{Project Size and Maturity\label{res-size}}
This section presents an analysis about how programmers use types in their code depending on the project size.
We start by calculating the Spearman Rank Correlation Coefficient between the number of lines of code and the usage of types.
This coefficient, which can go from -1 to 1, measures the correlation between two variables.
A positive value means that, as the size of projects grows, so does the usage of types.
A negative value means the opposite.
Values close to 1 or -1 denote the strongest relationship while values above 0.5 or below -0.5 can be considered strong correlations.
Table \ref{tab:all_correlation_loc} shows the Spearman correlation for declarations grouped by type and visibility.
There are no correlations in this table that seem to suggest a strong correlation.
...
We start by running an analysis
...
\begin{tabular}{|c|c|c|c|c|}
\hline 
Declaration Type/Visibility	& LoC		& Age	&	Commits\\
\hline 
\hline 
...
\hline
\hline
\multirow{2}{*}{Field}		& Other			& 5749	& 0.43 		& 0.39	& 0.33 \\                
                			& Mature		& 251 	& 0.53 		& 0.48	& 0.27 \\
\hline                	
Constructor 				& Other			& 1484	& 0.80 		& 1.00	& 0.35 \\                
Parameter					& Mature		& 186 	& 0.84 		& 1.00	& 0.29 \\                
\hline	
Method      				& Other			& 4616	& 0.67 		& 0.86	& 0.37 \\                
Parameter					& Mature		& 251 	& 0.69 		& 0.80	& 0.30 \\                
\hline	
Method						& Other			& 5629	& 0.68 		& 0.75	& 0.32 \\                
Return		         		& Mature		& 252 	& 0.71 		& 0.77	& 0.25 \\                
\hline	
Local						& Other			& 5592	& 0.29 		& 0.17	& 0.32 \\                
Variable					& Mature		& 253 	& 0.32 		& 0.21	& 0.28 \\                
\hline
\end{tabular}
\label{fig:test_boxplot_type} 
\caption{Usage of types in all declarations by visibility of declaration}
...
\hline
\hline
\multirow{2}{*}{\cell{Public}}		& Other					& 5599	& 0.69		& 0.75 		& 0.29\\			 
{}									& Mature				& 253 	& 0.71		& 0.75 		& 0.24\\
\hline								 							  	  			  			  							
\multirow{2}{*}{\cell{Protected}}	& Other					& 2186	& 0.94		& 1.00 		& 0.19\\			 
									& Mature				& 201 	& 0.88		& 1.00 		& 0.21\\			 
\hline															  	  			  			  						
\multirow{2}{*}{\cell{Private}}		& Other					& 5772	& 0.43		& 0.40 		& 0.32\\			 
									& Mature				& 251 	& 0.53		& 0.50 		& 0.26\\			 
\hline						 			
\end{tabular}
\label{fig:background_boxplot_visibility}
\caption{Usage of types in projects by declaration visibility depending on the background of the programmers of a projects}
...
\hline 
\hline 
Field                  & 0.0000	& (0.058,0.169)	\\ \hline
Constructor Parameter  & 0.4889	& (0.000,0.000) \\ \hline
Method Parameter       & 0.1041	& (0.043,0.005) \\ \hline
Method Return          & 0.5880	& (0.036,0.039) \\ \hline
Local Variable         & 0.0001	& (0.015,0.077)	\\ 
\hline 
\end{tabular}
\label{tab:test_utest_type}
\caption{Mann-Whitney U Test results comparing mature projects to others by declaration type}
\end{table}
...
\hline 
\hline
Public		& 0.6330	& (0.034, 0.036) 	\\ \hline
Private		& 0.0000	& (0.000, 0.000)	\\ \hline
Protected	& 0.0000	& (0.060,0.167) 	\\ 
\hline 
\end{tabular}
\label{tab:test_utest_type}
\caption{Mann-Whitney U Test results comparing mature projects to others by declaration visibility}
\end{table}	
