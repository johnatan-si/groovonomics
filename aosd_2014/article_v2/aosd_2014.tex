...
% \hline
% {}			& \multicolumn{2}{c|}{Public}	& \multicolumn{2}{c|}{Protected}	& \multicolumn{2}{c|}{Private}	\\
% {}			& p 	& conf. interval			& p 	& conf. interval				& p 	& conf. interval			\\
% \hline
% \hline
% Public		& \multicolumn{2}{c|}{-}		& 0 & (-0.21, -0.18)			& 0 & (0.28, 0.31)			\tabularnewline \hline
% Protected		& 0 & (0.18,  0.21)			& \multicolumn{2}{c|}{-}			& 0 & (0.54,  0.57)			\tabularnewline \hline
% Private		& 0 & (-0.31, -0.28)		& 0 & (-0.57, -0.54)			& \multicolumn{2}{c|}{-}		\tabularnewline \hline
% \end{tabular}
% \label{tab:all_utest_type}
% \caption{Mann-Whitney U test results for the usage of types in declarations of all projects by visibility}
% \end{table}
