...
On the other hand, there is evidence that programmers with only statically typed languages in their portfolio tend to use types differently from all others.
