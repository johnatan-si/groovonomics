...
\begin{itemize}
	\item \textbf{Question Q1:} Do programmers use types to implicitly document their code? 
	\item \textbf{Question Q2:} Are types used less often when maintainability is not a concern?	
