...
\ppgccufmg{
  title={A Study About How Programmers Use Optional Typing},
  ...
  portuguesetitle={Um Estudo Sobre Como Programadores Utilizam Tipagem Opcional},
...
\begin{figure}[ht]
\centering \includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/languages.png}
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/histograms/5_all_types.png} 
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/boxplots/6_declarations_by_type.png} 
\vspace{0.3cm}
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/boxplots/23_declarations_by_visibility.png} 
...
% \begin{figure}[h]
% \centering 
% \includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/boxplots/11_returns_of_methods.png} 
...
% \begin{figure}[h]
% \centering 
% \includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/boxplots/14_parameters_of_methods.png} 
...
% \begin{figure}[h]
% \centering 
% \includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/boxplots/17_parameters_of_constructors.png} 
...
% \begin{figure}[h]
% \centering 
% \includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/all/boxplots/20_fields.png} 
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/test/comparison/boxplots/6_declarations_by_type.png} 
\vspace{0.1cm}
\renewcommand{\arraystretch}{1.2}
\small
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/script/comparison/boxplots/6_declarations_by_type.png} 
\vspace{0.1cm}
\renewcommand{\arraystretch}{1.2}
\small
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/background/comparison/boxplots/6_declarations_by_type.png} 
\vspace{0.1cm}
\renewcommand{\arraystretch}{1.2}
\small
...
\begin{figure}[ht]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/background/comparison/boxplots/23_declarations_by_visibility.png} 
\vspace{0.1cm}
\renewcommand{\arraystretch}{1.2}
\small
...
\begin{figure}[h!]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/size/comparison/boxplots/6_declarations_by_type.png} 
\vspace{0.1cm}
\renewcommand{\arraystretch}{1.2}
\small
...
\begin{figure}[h!]
\centering 
\includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/size/comparison/boxplots/23_declarations_by_visibility.png} 
\vspace{0.1cm}
\renewcommand{\arraystretch}{1.2}
\small
...
\begin{figure}[h]
\centering \includegraphics[width=0.45\textwidth]{../aosd_2014/analysis/result/change_commits_distribution.png} 
